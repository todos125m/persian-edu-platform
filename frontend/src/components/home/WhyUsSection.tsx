...
const features = [
  {
    icon: Video,
    title: 'آموزش ویدیویی با کیفیت',
    description: 'ویدیوهای آموزشی با کیفیت HD و صدای واضح برای یادگیری بهتر',
  },
  {
    icon: Clock,
    title: 'دسترسی نامحدود',
    description: 'یکبار خرید کنید و برای همیشه به دوره دسترسی داشته باشید',
  },
  {
    icon: RefreshCw,
    title: 'بروزرسانی مداوم',
    description: 'دوره‌ها به طور مرتب با جدیدترین تکنولوژی‌ها بروزرسانی می‌شوند',
  },
  {
    icon: MessageCircle,
    title: 'پشتیبانی فعال',
    description: 'پاسخگویی سریع به سوالات شما توسط مدرسین و تیم پشتیبانی',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: 'با انجام پروژه‌های عملی، مهارت‌های واقعی کسب کنید',
  },
];
